...
//==============================================================================
MyCompAudioProcessor::MyCompAudioProcessor()
...
//==============================================================================
const juce::String MyCompAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool MyCompAudioProcessor::acceptsMidi() const
{
...
bool MyCompAudioProcessor::producesMidi() const
{
...
bool MyCompAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double MyCompAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int MyCompAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int MyCompAudioProcessor::getCurrentProgram()
{
    return 0;
}

void MyCompAudioProcessor::setCurrentProgram (int /*index*/)
{
}

const juce::String MyCompAudioProcessor::getProgramName (int /*index*/)
{
    return {};
}

void MyCompAudioProcessor::changeProgramName (int /*index*/, const juce::String& /*newName*/)
{
}

//==============================================================================
void MyCompAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void MyCompAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool MyCompAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void MyCompAudioProcessor::updateState()
{
...
void MyCompAudioProcessor::splitBands(const juce::AudioBuffer<float> &inputBuffer)
{
...
void MyCompAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool MyCompAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* MyCompAudioProcessor::createEditor()
{
    return new MyCompAudioProcessorEditor (*this);
//    return new juce::GenericAudioProcessorEditor(*this);
}

//==============================================================================
void MyCompAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void MyCompAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
juce::AudioProcessorValueTreeState::ParameterLayout MyCompAudioProcessor::createParameterLayout()
{
...
{
    return new MyCompAudioProcessor();
}
